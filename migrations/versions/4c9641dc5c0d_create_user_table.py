...
def upgrade():
    ...
    sa.Column('id_user', postgresql.UUID(as_uuid=True), server_default=sa.text('gen_random_uuid()'), nullable=False),
    ...
    op.create_unique_constraint(None, 'todo', ['id_todo'])
